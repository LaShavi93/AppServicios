...
class RatingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'value' => ['type' => 'integer', 'length' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'ratings_fk0' => ['type' => 'index', 'columns' => ['costumer_id'], 'length' => []],
            'ratings_fk1' => ['type' => 'index', 'columns' => ['technical_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'ratings_fk0' => ['type' => 'foreign', 'columns' => ['costumer_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'ratings_fk1' => ['type' => 'foreign', 'columns' => ['technical_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
