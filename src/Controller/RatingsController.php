...
class RatingsController extends AppController
{
    ...
    public function add()
    {
        ...
        $CostumerUsers = $this->Ratings->Users->find('list', ['conditions' => ['Users.role_id' => '2'], 'limit' => 200]);
        $TechnicalUsers = $this->Ratings->Users->find('list', ['conditions' => ['Users.role_id' => '3'], 'limit' => 200]);
        $applications = $this->Ratings->Applications->find('list', ['limit' => 200]);
        $this->set(compact('rating', 'CostumerUsers', 'TechnicalUsers', 'applications'));
        $this->set('_serialize', ['rating']);
    }
